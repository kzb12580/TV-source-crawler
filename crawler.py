...
M3U8_NORMAL_KEYWORDS = [
    # 电视剧
    "甄嬛传", "知否知否应是绿肥红瘦", "琅琊榜", "武林外传", "新三国",
    "繁花", "庆余年", "乡村爱情", "狂飙", "漫长的季节", "三体", "人世间", "苍兰诀",
    # 美剧/韩剧/英剧
    "老友记", "Friends", "生活大爆炸", "The Big Bang Theory",
    "权力的游戏", "Game of Thrones", "请回答1988", "神秘博士",
    # 动漫
    "海贼王", "航海王", "名侦探柯南", "火影忍者", "鬼灭之刃", "进击的巨人",
    "斗罗大陆", "完美世界", "凡人修仙传", "狐妖小红娘", "死神", "银魂",
    # 综艺
    "快乐大本营", "乘风破浪的姐姐", "Running Man", "奔跑吧",
    # 纪录片/电影
    "地球脉动", "流浪地球", "孤注一掷",
]
